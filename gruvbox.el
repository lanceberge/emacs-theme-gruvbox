...
(defmacro gruvbox-deftheme (name description palette &rest body)
  `(autothemer-deftheme
    ...
    ((default                                   (:background gruvbox-bg :foreground gruvbox-light1))
     ...
     (mode-line                                 (:background gruvbox-bg :foreground gruvbox-light2 :box nil))
     ...
     (line-number-current-line                  (:foreground gruvbox-bright_orange :background gruvbox-bg))
     ...
     (diff-refine-added                         (:background gruvbox-faded_green  :foreground gruvbox-light1))
     (diff-removed                              (:background 'unspecified  :foreground gruvbox-neutral_red))
     (diff-refine-removed                       (:background gruvbox-faded_red  :foreground gruvbox-light1))
     ...
     (org-level-1                               (:foreground gruvbox-bright_blue :bold gruvbox-bold-constructs :height 1.05))
     (org-level-2                               (:foreground gruvbox-bright_orange :bold gruvbox-bold-constructs :height 1.05))
     (org-level-3                               (:foreground gruvbox-bright_purple :bold gruvbox-bold-constructs :height 1.05))
     (org-level-4                               (:foreground gruvbox-bright_green :bold gruvbox-bold-constructs :height 1.05))
     (org-level-5                               (:foreground gruvbox-bright_blue :bold gruvbox-bold-constructs))
     (org-level-6                               (:foreground gruvbox-bright_orange :bold gruvbox-bold-constructs))
     (org-level-7                               (:foreground gruvbox-faded_purple :bold gruvbox-bold-constructs))
     (org-level-8                               (:foreground gruvbox-bright_green :bold gruvbox-bold-constructs))
     ...
     (org-link                                  (:foreground gruvbox-bright_green :underline t))
     ...
     (org-block                                 (:background gruvbox-bg))
     (org-block-begin-line                      (:background gruvbox-bg :foreground gruvbox-dark4))
     (org-block-end-line                        (:background gruvbox-bg :foreground gruvbox-dark4))
     (org-formula                               (:foreground gruvbox-bright_yellow))
     (org-document-title                        (:foreground gruvbox-light0))
     (org-document-info                         (:foreground gruvbox-light1))
